...
# Lab 3: การเชื่อมต่อเซ็นเซอร์

- [Lab 3: การเชื่อมต่อเซ็นเซอร์](#lab-3-การเชื่อมต่อเซ็นเซอร์)
  - [3.1 การใช้เซ็นเซอร์อะนาลอกแบบความต้านทาน (Resistance-based Analog Sensors)](#31-การใช้เซ็นเซอร์อะนาลอกแบบความต้านทาน-resistance-based-analog-sensors)
    ...
    - [ส่งงาน - แสดงภาพแสดงขั้นตอนการทำ Lab พร้อมบรรยายให้เข้าใจ](#ส่งงาน---แสดงภาพแสดงขั้นตอนการทำ-lab-พร้อมบรรยายให้เข้าใจ)
  - [3.2 Hysteresis & Low-pass Filter - วิธีป้องกันไม่ให้เกิดการเปลี่ยน State ถี่เกินไป](#32-hysteresis-low-pass-filter-วิธีป้องกันไม่ให้เกิดการเปลี่ยน-state-ถี่เกินไป)
  - [ตัวอย่าง - โคมไฟอัตโนมัติ](#ตัวอย่าง-โคมไฟอัตโนมัติ)
    ...
    - [ส่งงาน - แสดงภาพแสดงขั้นตอนการทำ Lab พร้อมบรรยายให้เข้าใจ](#ส่งงาน---แสดงภาพแสดงขั้นตอนการทำ-lab-พร้อมบรรยายให้เข้าใจ-1)

---

## 3.1 การใช้เซ็นเซอร์อะนาลอกแบบความต้านทาน (Resistance-based Analog Sensors)
...
```c
#define LDR 36    // use gpio36 or A1
...
---
### ส่งงาน - แสดงภาพแสดงขั้นตอนการทำ Lab พร้อมบรรยายให้เข้าใจ ###
