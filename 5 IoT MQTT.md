# การสื่อสารกับสมองกลฝังตัวผ่าน MQTT
...
![](images/mqtt-webclient.png)ภาพแสดงการเชื่อมต่อ MQTT Broker โดยใช้ Web Client
...
![](images/mqtt-subscribe.png)แสดงตัวอย่างการ subscribe

### ทดลอง publish ไปยัง topic

ใน Web Client ให้ลอง publish ค่าไปยัง topic ที่ subscribe ไว้ข้างต้น

![](images/mqtt-publish.png)แสดงตัวอย่างการ publish หาตัวเอง
...
การใช้งาน Code ข้างต้นจะต้องรู้ SSID และ Password ของ Wifi ที่ประสงค์ใช้ ซึ่ง Wifi ในองค์กรเช่นมหาวิทยาลัย มักต้องมีการ login ด้วยบัญชีผู้ใช้ก่อนเสมอ จะไม่สามารถใช้งานกับ ESP32 ด้วยวิธีข้างต้นได้ ทางแก้ไขคือ
  ...
  1. **ปล่อย wifi จากโทรศัพท์** — มักเป็นวิธีที่ง่ายที่สุดสำหรับการทดลอง แต่อาจไม่เหมาะกับการใช้งานจริง
...
> Library สำหรับสื่อสารผ่าน MQTT ใน Arduino มาหลายตัวให้เลือก ในปฏิบัติการนี้เลือก library ชื่อ MQTT by Joel Gaehwiler ([ดูคู่มือบน Github](<https://github.com/256dpi/arduino-mqtt>))ข้างต้นเพราะค่อนข้างเป็นที่นิยม และการเขียนโปรแกรมเข้าใจได้ง่าย

![](images/mqtt-library.png)ภาพแสดงการติดตั้ง MQTT Library
...
ต่อไปให้ ต่อ LED เข้ากับขาของ ESP32 แล้วเขียนโปรแกรมเพื่อควบคุมการเปิด-ปิดไฟนั้นผ่าน Web Client

  * เมื่อส่งคำว่า “on” — ให้เปิด LED
  * เมื่อส่งคำว่า “off” — ให้ปิด LED
...
การทดลอง 4 สร้าง MQTT Dashboard
...
**4.1 เข้าใช้งาน**[**MQTT Tiles**](<https://mqtttiles.flespi.io/>)**และเชื่อมต่อ MQTT**

[**MQTT Tiles**  
 _MQTT-based IoT dashboard visualization tool_ mqtttiles.flespi.io](<https://mqtttiles.flespi.io/> "https://mqtttiles.flespi.io/")[](<https://mqtttiles.flespi.io/>)
...
![](images/mqtt-connected.png)แสดงตัวอย่างการเชื่อมต่อที่สำเร็จแล้ว
...
![](images/mqtt-widget.png)แสดงตัวอย่าง Widget ที่แสดงค่าจาก ESP32
...
![](images/mqtt-button.png)แสดงตัวอย่างการตั้งค่าปุ่มกด
...
By [Learning Inventions Laboratory](<https://medium.com/@lil.eng.cmu>) on [December 9, 2022](<https://medium.com/p/47633bb76e58>).

[Canonical link](<https://medium.com/@lil.eng.cmu/%E0%B8%81%E0%B8%B2%E0%B8%A3%E0%B8%AA%E0%B8%B7%E0%B9%88%E0%B8%AD%E0%B8%AA%E0%B8%B2%E0%B8%A3%E0%B8%81%E0%B8%B1%E0%B8%9A%E0%B8%AA%E0%B8%A1%E0%B8%AD%E0%B8%87%E0%B8%81%E0%B8%A5%E0%B8%9D%E0%B8%B1%E0%B8%87%E0%B8%95%E0%B8%B1%E0%B8%A7%E0%B8%9C%E0%B9%88%E0%B8%B2%E0%B8%99-mqtt-47633bb76e58>)

Exported from [Medium](<https://medium.com>) on November 25, 2025.
