...
3. Disable internal pullup
4. ลองโปรแกรมเดิม ควรเห็นว่าพฤติกรรมจะตรงกันข้ามกับที่เราต้องการ คือจะกลายเป็น "กดดับ-ปล่อยติด" 
5. แก้ไโปรแกรมให้พฤติกรรมกลับมาถูกต้อง คือ "กดติด-ปล่อยดับ"
6. ดูพฤติกรรม GPIO ของ LED และ ปุ่มกด ใน PulseView
