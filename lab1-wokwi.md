...
- [LAB 1.4 - นับจำนวนครั้งที่กดปุ่ม](#lab-14---นับจำนวนครั้งที่กดปุ่ม)
  - [เป้าหมาย](#เป้าหมาย)
  - [ขั้นตอน](#ขั้นตอน-3)
  - [สิ่งที่ต้องส่ง](#สิ่งที่ต้องส่ง-3)
- [LAB 1.5 - ดูสัญญาณ Bounce ด้วย Logic Analyzer](#lab-15---ดูสัญญาณ-bounce-ด้วย-logic-analyzer)
  - [ขั้นตอน](#ขั้นตอน-4)
...
- เปิดใช้ Inputernal pull-up ด้วยคำสั่งนี้ใน setup()
