...
- จากระดับความสว่างที่ทำไป 5 ระดับ ให้เลือกมา 2 ระดับ และแสดงรูป pulse  (เช่นระดับที่ duty ค่อนข้างสูง และระดับที่ค่อนข้างต่ำ)
- ใช้ Logic Analyzer วัด ความถี่และ duty ของสัญญาณ PWM นั้น
- อธิบายหลักการ PWM ที่ได้เรียนรู้ใน Lab นี้

### Lab PWM 3 สร้าง PWM เอง เพื่อคุม Servo Motor 

- Lab PWM 2 ไม่ต้องส่ง
- แสดงรูป pulse ที่ใช้ควบคุม servo โดยเลือกตำแหน่งแขน Servo มาแสดง 2 ตำแหน่ง
- แสดงภาพ servo ขณะทำงานตาม pulse ข้างต้น เพื่อกดปุ่มตามการทำงานของ Useless machine
...
- ใช้คำสั่ง ledcwrite() ในการสร้าง PWM
- คาบของ PWM = 20 ms (50 Hz)  
- Pulse width = 1–2.5 ms → 0–180 องศา  
- 1 องศา ≈ 5.67 µs  
...
ถ้าใช้ PWM Resolution ความละเอียดสูงขึ้น เช่น 10 bit → คุมมุมได้ละเอียดขึ้น
